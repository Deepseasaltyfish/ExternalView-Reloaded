...
public class Configs {
    ...
    static {
        Pair<Configs, ForgeConfigSpec> pair =
                new ForgeConfigSpec.Builder().configure(Configs::new);
    ...
    private static final String DEFAULT_BLOCK_CMD =
            "attribute @s forge:block_reach base set {value}";

    private static final String DEFAULT_ENTITY_CMD =
            "attribute @s forge:entity_reach base set {value}";
    ...
    private Configs(ForgeConfigSpec.Builder builder) {
        ...
        reach = builder
                .comment("Reach Distance")
                .defineInRange("reach", 40.0, 1.0, 1024.0);

        defaultReach = builder
                .comment("Default Reach Distance")
                .defineInRange("defaultReach", 5.0, 1.0, 1024.0);

        blockReachCommand = builder
                .comment("Block reach command")
                .define("blockReachCommand", DEFAULT_BLOCK_CMD);

        entityReachCommand = builder
                .comment("Entity reach command")
                .define("entityReachCommand", DEFAULT_ENTITY_CMD);
